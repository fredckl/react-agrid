...
import { is, pathOr, splitEvery, isNil, propOr, ifElse, hasPath, always } from 'rambda';
...
var Agrid = function Agrid(_ref) {
  ...
  var getColProps = function getColProps(rowIndex, colIndex) {
    if (isNil(colsByRow)) {
      ...
      return ifElse(hasPath([rowIndex, colIndex]), pathOr({}, [rowIndex, colIndex]), always({}))(colProps);
    }
  };
  ...
  return rowChildren.map(function (_children, rowIndex) {
    ...
    return /*#__PURE__*/React.cloneElement(row, _objectSpread2(_objectSpread2({}, rowProps), {}, {
      key: rowKey,
